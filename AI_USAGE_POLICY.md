...
*Note: Training or generating based on any data governed by this project is subject to licensing and can easily constitute a copyright infringement as explained in the [ReadMe](README.md)'s section about licensing. This document only details the use of AI for [contributions](CONTRIBUTING.md) made to this project.*
...
- using IDEs or editors which have been developed using AI (e.g. JetBrains IDEs such as IDEA or CLion) as long as active authoring is prevented
...
- using compilers or runtimes that have been developed using AI, as long as they don't generate output actively using AI when being invoked
